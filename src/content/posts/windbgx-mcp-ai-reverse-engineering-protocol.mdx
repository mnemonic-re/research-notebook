...
<Note>
WinDbgX-MCP packages both Python server management and pre-compiled 64bit and 32bit native extension DLLs (<code>de.dll</code>) into a single, zero configuration <code>pip</code> wheel with automatic binary path discovery.
</Note>
